...
# Set figure title
#.title('Close Stock Price History [2009 - 2019]', fontsize=16)
# Set x label
...
ff['Prediction'] = svclassifier.predict(np.array(ff.index).reshape(-1, 1))

from sklearn.metrics import explained_variance_score
explained_variance_score(y_test, y_pred)

print('Accuracy by SVM Model->',explained_variance_score(y_test, y_pred))
...
# Set figure title
plt.title('SVM->Comparison Predicted vs Actual Number Of Users in Sample data selection', fontsize=16)
