...
# Set figure title
plt.title('Linear->Comparison Predicted vs Actual Number Of Users in Sample data selection', fontsize=16)
...
print('Accuracy by LinearRegression Model -> ',explained_variance_score(y_test, y_pred))
